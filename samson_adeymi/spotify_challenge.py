...
# result =   # fill this in
results = sp.search( "Beyonce", type='artist')
...
print(results['artists']['items'][0]['name']) # uncomment if you want to see the results
...
chosen_artists = ['drake' , 'lil wayne' , 'kanye west' , 'summer walker', 'elle mai']
popularities = []
