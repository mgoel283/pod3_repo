...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist,{'artist' : 'usher', 'title' : 'nice and slow'})
add_song(my_playlist,{'artist' : 'drake', 'title' :'marvins'})
...
print('Question 5')
add_song(my_playlist,{'artist' : 'toni braxton', 'title' : 'spanish gutar'})
add_song(my_playlist,{'artist' : ' kendrick lamar', 'title' : 'stay humble'})
display_playlist(my_playlist)
...
average_song_plays = np.mean(monthly_plays)
print(average_song_plays)
