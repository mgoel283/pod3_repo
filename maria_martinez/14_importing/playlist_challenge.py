...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist,{'artist':'Flo Milli','title': 'Roaring 20s'} )
...
print('Question 5')
add_song(my_playlist,{'artist':'21 Savage','title': 'a lot'} )
add_song(my_playlist,{'artist':'Zapp','title': 'Computer Love'} )
