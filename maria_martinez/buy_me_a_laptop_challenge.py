...
print(f"1. {laptops[0]['url']}")

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print("2.")
for i in range(len(laptops[0]['types'][0]['price'])):
    print(laptops[0]['types'][0]['price'][i])
print("\n")
# TODO: Write code to print all the color options for Dell XPS 13.
print("3.")
for i in range(len(laptops[1]['types'][0]['colors'])):
    print(laptops[1]['types'][0]['colors'][i])
print("\n")
...
print("Suppose that the 13-inch MacBook Pro in space gray color is sold out. Also, the same 16-inch laptop with 1 TB storage is out of stock as well. Update the list of dictionaries such that these options are removed. Print the updated dictionary.")

# TODO: Update the laptops dictionary.
print("Before change")
for i in range(len(laptops[0]['types'][0]['colors'])):
    print(laptops[0]['types'][0]['colors'][i])
for i in range(len(laptops[0]['types'][1]['storage'])):
    print(laptops[0]['types'][1]['storage'][i])
...
for i in range(len(laptops)):
    for j in range(len(laptops[i]['types'])):  
        for k in range(len(laptops[i]['types'][j]['price'])):
            print(laptops[i]['productName'])
            print(laptops[i]['types'][j]['screen_size'])
            print(f"${laptops[i]['types'][j]['price'][k]}")
            print("\n")
