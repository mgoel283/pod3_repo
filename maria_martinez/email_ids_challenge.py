...
for i in range (len(names)):
    lowerNames=names[i].lower()
    namesList=lowerNames.split(' ')
    removeSpaceInBetween = '.'.join(namesList)
    joinedNames=dot.join(namesList)
    employeeEmails=joinedNames+'@ripplemedia.com'
    emails.append(employeeEmails)
