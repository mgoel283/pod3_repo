...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist,{'artist':'EST Gee','title': 'Young Shiner'} )
...
print('Question 5')
add_song(my_playlist,{'artist':'Rick Ross','title': 'Pushin It'} )
add_song(my_playlist,{'artist':'Jay-Z','title': 'You Must Love Me'} )
