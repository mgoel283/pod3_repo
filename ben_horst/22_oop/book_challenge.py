...
book_count = my_library.count_books()
print(f"There are {book_count} books in the list.")
...
print("Testing removing a book not in the list")
my_library.remove_title('happy days')
print(my_library.books)
