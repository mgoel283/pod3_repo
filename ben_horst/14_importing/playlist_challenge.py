...
add_song(my_playlist, {'artist': 'Atlas Genius', 'title': 'Trojans'})
...
add_song(my_playlist, {'artist': 'Drake', 'title': 'Underground King'})
add_song(my_playlist, {'artist': 'The Beatles', 'title': 'Norwegian Wood'})
