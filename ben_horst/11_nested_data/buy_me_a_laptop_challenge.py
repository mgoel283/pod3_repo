...
print(f'All of the possible prices for the 16-inch MacBook Pro are: {laptops[0]["types"][1]["price"]}')

print()

# TODO: Write code to print all the color options for Dell XPS 13.

print(f'All of the color options for the Dell XPS 13 inch are: {laptops[1]["types"][0]["colors"]}')

print()

# TODO: Write code to print the description of Dell XPS laptop.

print(f'The description of the Dell XPS laptop is: {laptops[1]["description"]}')
