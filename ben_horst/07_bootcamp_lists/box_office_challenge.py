...
print("Convert movies_str into a list:")
...
print("Confirming movie count:")

print(len(remaining_50_list))

print()

print("Joining the two movie lists:")
...
print("Printing the first movie in the top 100 list:")
...
print("Printing the top 10 movies in the top 100 list:")
...
print("Converting top_100 back to a string:")
