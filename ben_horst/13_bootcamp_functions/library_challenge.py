...
def search_by_name(book):
    if book in books:
        print(f'This book {book} is Available!')
    else:
        print(f'This book {book} is NOT Available!')
...
print('Question 2.0:')
print('It is a list of Dictionaires!')
print()
...
def count_books():
    return print(f'There are {len(books_with_details)} books in the list!')
