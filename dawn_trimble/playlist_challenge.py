...
'''
add_song(my_playlist,{'artist': 'Down', 'title': 'Stone the Crow'})
...
print('Question 5')
add_song(my_playlist,{'artist': 'Ani Difranco', 'title': 'Out of Habit'})
add_song(my_playlist,{'artist': 'Billy Joel', 'title': 'Vienna'})
print(display_playlist(my_playlist))
...
song_count = get_playlist_length(my_playlist)
print(song_count)
